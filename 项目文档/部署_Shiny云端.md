...
| **C · shinylive (WASM)** | 希望完全零服务器 | 用户浏览器内直接跑 → [`项目文档/部署_浏览器仪表盘.md`](./项目文档/部署_浏览器仪表盘.md) |
...
- shinylive（浏览器内 WASM）→ [`项目文档/部署_浏览器仪表盘.md`](./项目文档/部署_浏览器仪表盘.md)
- 静态站点 Pages → [`项目文档/部署_GitHub_Pages.md`](./项目文档/部署_GitHub_Pages.md)
