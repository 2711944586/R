...
.ghs_css <- function() {
  paste(c(
    ":root{--ink:#1a1a1a;--muted:#6b7280;--paper:#ffffff;--paper-2:#f9fafb;--line:rgba(0,0,0,.06);--line-strong:rgba(0,0,0,.12);--blue:#111827;--orange:#374151;--green:#059669;--code-bg:#111827;--code-ink:#f3f4f6}",
    ...
    "a{color:var(--blue)}",
    ".hero{position:relative;min-height:88vh;padding:30px 0 90px;color:#1a1a1a;background:#ffffff;overflow:hidden}",
    ".hero:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 70% 20%,rgba(243,244,246,.8),transparent 50%),radial-gradient(circle at 20% 80%,rgba(229,231,235,.6),transparent 50%);pointer-events:none}",
    ...
    ".eyebrow{display:inline-flex;align-items:center;gap:8px;padding:8px 14px;border:1px solid rgba(0,0,0,.1);border-radius:999px;background:rgba(0,0,0,.03);font-size:12px;letter-spacing:.14em;text-transform:uppercase;color:#6b7280}",
    ".hero h1{font-size:clamp(48px,7vw,96px);line-height:1.02;margin:24px 0 22px;font-weight:700;color:#1a1a1a}",
    ".hero h1 .accent{background:linear-gradient(120deg,#374151,#111827);-webkit-background-clip:text;background-clip:text;color:transparent}",
    ".hero-lead{font-size:19px;max-width:780px;color:#4b5563;margin:0 0 30px}",
    ".hero-actions{display:flex;flex-wrap:wrap;gap:12px}",
    ".btn{display:inline-flex;align-items:center;gap:8px;padding:13px 22px;border-radius:999px;background:#111827;color:#fff;font-weight:700;text-decoration:none;border:0;font-size:14px;letter-spacing:.02em;box-shadow:0 4px 12px rgba(0,0,0,.15);transition:transform .2s,box-shadow .2s}",
    ".btn:hover{transform:translateY(-1px);box-shadow:0 8px 24px rgba(0,0,0,.2)}",
    ".btn.alt{background:#fff;color:#1a1a1a;border:1px solid rgba(0,0,0,.12);box-shadow:0 2px 8px rgba(0,0,0,.06)}",
    ".btn.alt:hover{border-color:rgba(0,0,0,.2);box-shadow:0 4px 16px rgba(0,0,0,.1)}",
    ".btn.ghost{background:transparent;color:#4b5563;border:1px solid rgba(0,0,0,.12);box-shadow:none}",
    ".btn.ghost:hover{border-color:rgba(0,0,0,.25);color:#1a1a1a}",
    ".hero-panel{position:relative;border:1px solid rgba(0,0,0,.08);border-radius:24px;padding:24px;background:#f9fafb}",
    ".hero-panel-tag{display:inline-block;font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#6b7280;font-weight:800}",
    ".hero-panel-list{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:12px}",
    ".hero-panel-list li{display:flex;align-items:baseline;gap:14px;border-bottom:1px solid rgba(0,0,0,.06);padding-bottom:10px;font-size:15px;color:#4b5563}",
    ".hero-panel-list li:last-child{border-bottom:0}",
    ".hero-panel-list li b{font-family:'Source Serif 4',serif;font-size:34px;color:#111827;font-weight:700;min-width:64px}",
