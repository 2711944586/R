...
.ghs_hero <- function(s, project_url, n_fig, n_widget) {
  ...
  sprintf(
    paste0(
      ...
      "<div><span class='eyebrow'>Global Health Expenditure \u00b7 %d countries \u00b7 %d years \u00b7 integrated analysis</span>",
      "<h1>\u5168\u7403\u536b\u751f\u652f\u51fa 2000\u20132023\uff1a",
      "<span class='accent'>\u516c\u5e73\u3001\u97e7\u6027\u3001\u672a\u6765</span></h1>",
      "<p class='hero-lead'>WHO GHED + WDI \u957f\u9762\u677f\u7684\u6570\u636e\u5de5\u7a0b\u3001\u7edf\u8ba1\u5efa\u6a21\u4e0e\u53ef\u89c6\u5316\u3002%d \u5f20\u9759\u6001\u56fe\u3001%d \u4e2a\u4ea4\u4e92\u7ec4\u4ef6\u300136 \u4e2a Shiny \u6a21\u5757\u3001F1\u2013F14 \u6838\u5fc3\u53d1\u73b0\u3002</p>",
      "<div class='hero-actions'>",
      "<a class='btn' href='#executive'>\u6458\u8981 \u2192</a>",
      "<a class='btn alt' href='#findings'>14 \u9879\u53d1\u73b0</a>",
      "<a class='btn ghost' href='%s'>GitHub</a>",
      "<a class='btn ghost' href='./\u4eea\u8868\u76d8/'>Shiny</a></div></div>",
      "<aside class='hero-panel'><span class='hero-panel-tag'>\u9875\u9762\u6784\u6210</span>",
      "<ul class='hero-panel-list'>",
      "<li><b>%d</b><span>\u56fd\u5bb6 \u00b7 %d \u5e74\u9762\u677f</span></li>",
      "<li><b>%d</b><span>\u9759\u6001\u56fe\u8868 (PNG + SVG)</span></li>",
      "<li><b>%d</b><span>\u4ea4\u4e92\u7ec4\u4ef6 (plotly / leaflet / DT)</span></li>",
      "<li><b>36</b><span>\u5185\u5bb9\u7ae0\u8282\u00b7\u6458\u8981\u5230\u590d\u73b0</span></li>",
      "</ul></aside></div></header>"
    ),
    dock_html,
    s$n_country, s$span, n_fig, n_widget,
...
.ghs_css <- function() {
  paste(c(
    ":root{--ink:#1a1a1a;--muted:#6b7280;--paper:#fafafa;--paper-2:#f4f4f5;--line:rgba(0,0,0,.06);--line-strong:rgba(0,0,0,.1);--blue:#18181b;--orange:#44403c;--green:#059669;--code-bg:#18181b;--code-ink:#fafafa}",
    ...
    "a{color:var(--blue)}",
    ".hero{position:relative;min-height:100vh;padding:0;display:flex;align-items:center;justify-content:center;color:#fafafa;background:#18181b;overflow:hidden}",
    ".hero:before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 40%,rgba(63,63,70,.4),transparent),radial-gradient(circle at 80% 80%,rgba(39,39,42,.6),transparent 50%);pointer-events:none}",
    ".hero:after{content:'';position:absolute;inset:0;background:url(\"data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='1' cy='1' r='.6' fill='rgba(255,255,255,.03)'/%3E%3C/svg%3E\");pointer-events:none}",
    ...
    ".hero-grid{display:grid;grid-template-columns:1fr;gap:0;padding:0 24px;position:relative;text-align:center;max-width:900px;margin:0 auto}",
    ".eyebrow{display:inline-flex;align-items:center;gap:8px;padding:8px 18px;border:1px solid rgba(255,255,255,.12);border-radius:999px;background:rgba(255,255,255,.04);font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:rgba(255,255,255,.5);animation:ghs-hero-fade 1s ease .2s both}",
    ".hero h1{font-size:clamp(44px,8vw,88px);line-height:.98;margin:28px 0 24px;font-weight:800;color:#fafafa;letter-spacing:-.03em;animation:ghs-hero-fade 1s ease .4s both}",
    ".hero h1 .accent{background:linear-gradient(135deg,#a1a1aa,#fafafa 50%,#a1a1aa);-webkit-background-clip:text;background-clip:text;color:transparent}",
    ".hero-lead{font-size:18px;max-width:640px;color:rgba(255,255,255,.6);margin:0 auto 36px;line-height:1.7;animation:ghs-hero-fade 1s ease .6s both}",
    ".hero-actions{display:flex;flex-wrap:wrap;gap:12px;justify-content:center;animation:ghs-hero-fade 1s ease .8s both}",
    ".btn{display:inline-flex;align-items:center;gap:8px;padding:14px 28px;border-radius:999px;background:#fafafa;color:#18181b;font-weight:700;text-decoration:none;border:0;font-size:14px;letter-spacing:.01em;box-shadow:0 4px 16px rgba(0,0,0,.3);transition:transform .2s,box-shadow .2s}",
    ".btn:hover{transform:translateY(-2px);box-shadow:0 8px 28px rgba(0,0,0,.4)}",
    ".btn.alt{background:rgba(255,255,255,.08);color:#fafafa;border:1px solid rgba(255,255,255,.15);box-shadow:none;backdrop-filter:blur(8px)}",
    ".btn.alt:hover{background:rgba(255,255,255,.14);border-color:rgba(255,255,255,.25)}",
    ".btn.ghost{background:transparent;color:rgba(255,255,255,.6);border:1px solid rgba(255,255,255,.1);box-shadow:none}",
    ".btn.ghost:hover{color:#fafafa;border-color:rgba(255,255,255,.25)}",
    ".hero-panel{display:none}",
    ".hero-panel-tag,.hero-panel-list{display:none}",
    "@keyframes ghs-hero-fade{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}",
    ...
    ".kpi-section{background:#f9fafb}",
    ".section-head{margin-bottom:42px;max-width:880px}",
    ".section-head .kicker{display:inline-block;font-size:12px;letter-spacing:.22em;text-transform:uppercase;color:#374151;margin-bottom:10px;font-weight:800}",
    ...
    ".kpi{position:relative;padding:24px 22px;border:1px solid var(--line);border-radius:16px;background:#ffffff;box-shadow:0 1px 3px rgba(0,0,0,.04);overflow:hidden}",
    ".kpi:before{content:'';position:absolute;left:0;top:0;width:4px;height:100%;background:#111827}",
    ".kpi-value{font-family:'Source Serif 4',serif;font-size:38px;font-weight:700;color:#111827;line-height:1.1}",
    ".kpi-label{margin-top:10px;font-weight:800;font-size:13px;letter-spacing:.04em;color:#374151}",
    ".kpi-note{margin-top:6px;font-size:12.5px;color:#6b7280;line-height:1.55}",
    ".methods .code-figure{margin:14px 0 22px}",
    ".finding{padding:104px 0;border-top:1px solid var(--line)}",
    ".finding:nth-of-type(odd){background:#f9fafb}",
    ...
    ".top-bar{position:fixed;left:0;right:0;top:0;height:2px;background:rgba(0,0,0,.04);z-index:60;pointer-events:none}",
    "#read-progress{height:100%;width:0;background:#111827;transition:width .12s linear}",
    ...
    "html[data-theme='dark'] .hero{background:radial-gradient(circle at 18% 0%,#06080d 0%,#000 60%),radial-gradient(circle at 90% 110%,rgba(212,129,70,.5),transparent 55%)}",
    "html[data-theme='dark'] .code-figure{background:#06080d}",
    "html[data-theme='dark'] .code-pre,html[data-theme='dark'] .code-caption{background:transparent;color:#e6efff}",
    "html[data-theme='dark'] .fig-frame{background:linear-gradient(180deg,#11161f,#161c2a)}",
    "html[data-theme='dark'] .gallery-card,html[data-theme='dark'] .gallery-card img{background:#161c2a}",
    "html[data-theme='dark'] .gallery-button{background:#11161f}",
    "html[data-theme='dark'] .pill,html[data-theme='dark'] .gallery-meta span{background:#3a2a18;color:#f7c08a}",
    "html[data-theme='dark'] .tabs button{background:#161c2a;color:#e7e9ee;border-color:rgba(255,255,255,.18)}",
    "html[data-theme='dark'] .tabs button.active{background:#f7c08a;color:#06080d;border-color:#f7c08a}",
    ...
    "html[data-theme='dark'] .widget-frame-wrap{background:#06080d}",
    "html[data-theme='dark'] .widget-embed{background:#161c2a}",
    "html[data-theme='dark'] .widget-embed summary{color:#f7c08a}",
    "html[data-theme='dark'] .widget-embed-frame{background:#06080d}",
    "html[data-theme='dark'] .cmd-card header{background:#11161f;color:#f7c08a}",
    "html[data-theme='dark'] .cmd-note{color:#9aa3b3}",
    "html[data-theme='dark'] .conc-card h3{color:#e7e9ee}",
    "html[data-theme='dark'] a{color:#f7c08a}",
    "html[data-theme='dark'] .findings-anchor{background:transparent}",
    "html[data-theme='dark'] .conc-card p,html[data-theme='dark'] .country-card p,html[data-theme='dark'] .widget-card p,html[data-theme='dark'] .gallery-meta em,html[data-theme='dark'] .exec-hint{color:#9aa3b3}",
    "html[data-theme='dark'] .exec-num,html[data-theme='dark'] .country-card .pill{color:#f7c08a}",
    "html[data-theme='dark'] .country-card .pill{background:#3a2a18}",
    "html[data-theme='dark'] .glossary-sources h3{color:#f7c08a}",
    "html[data-theme='dark'] .limit{background:#161c2a;color:#9aa3b3}",
    "html[data-theme='dark'] .limit h3{color:#f7c08a}",
    "html[data-theme='dark'] .site-footer{background:#06080d}",
    ".widget-embed{background:linear-gradient(135deg,#fff,#fbf6ee);border:1px solid var(--line-strong);border-radius:18px;padding:0;overflow:hidden;box-shadow:0 12px 28px rgba(13,18,27,.06)}",
    ".widget-embed summary{cursor:pointer;padding:14px 20px;display:flex;justify-content:space-between;align-items:center;gap:14px;list-style:none;font-size:14px;color:var(--blue);font-weight:700}",
    ".widget-embed summary::-webkit-details-marker{display:none}",
    ".widget-embed summary::before{content:'\u25b6';display:inline-block;margin-right:8px;color:var(--orange);transition:transform .2s ease;font-size:11px}",
    ".widget-embed[open] summary::before{transform:rotate(90deg)}",
    ".widget-embed strong{font-size:13px;letter-spacing:.16em;text-transform:uppercase;color:var(--orange);font-weight:800}",
    ".widget-embed .widget-meta{font-size:12px;color:var(--muted);font-weight:600}",
    ".widget-embed-frame{position:relative;background:#fbf6ee;height:0;overflow:hidden;transition:height .3s ease}",
    ".widget-embed[open] .widget-embed-frame{height:560px;border-top:1px solid var(--line)}",
    ".widget-embed iframe{width:100%;height:100%;border:0;background:#fff}",
    ".widget-embed-links{display:flex;gap:14px;padding:10px 20px 14px;background:#fbf6ee;font-size:12.5px}",
    ".widget-embed-links a{color:var(--blue);text-decoration:none;border-bottom:1px dashed var(--blue)}",
...
.ghs_js <- function() {
  paste(c(
    ...
    "function toggleTheme(){var html=document.documentElement;var cur=html.getAttribute('data-theme')||'light';var nxt=cur==='light'?'dark':'light';html.setAttribute('data-theme',nxt);try{localStorage.setItem('ghs-theme',nxt);}catch(e){}document.querySelectorAll('.theme-toggle').forEach(function(btn){btn.textContent=nxt==='dark'?'\u263d':'\u2600';});}",
...
.ghs_css_polish <- function() {
  paste(c(
    ...
    ".dock-toggle{width:52px;height:52px;border-radius:50%;border:none;background:#111827;color:#fff;font-size:20px;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,.15),0 1px 3px rgba(0,0,0,.1);transition:transform .2s cubic-bezier(.4,0,.2,1),box-shadow .2s,background .3s;display:flex;align-items:center;justify-content:center;position:relative;z-index:2}",
    ".dock-toggle:hover{transform:scale(1.08);box-shadow:0 8px 24px rgba(0,0,0,.2)}",
    ".dock-icon-close{display:none}",
    ".ghs-dock.open .dock-icon-open{display:none}",
    ".ghs-dock.open .dock-icon-close{display:inline}",
    ".ghs-dock.open .dock-toggle{background:#374151}",
    ".dock-panel{position:absolute;bottom:64px;right:0;width:320px;max-height:70vh;overflow-y:auto;background:rgba(255,255,255,.92);backdrop-filter:blur(24px) saturate(140%);-webkit-backdrop-filter:blur(24px) saturate(140%);border:1px solid rgba(0,0,0,.08);border-radius:20px;padding:0;opacity:0;transform:translateY(12px) scale(.95);pointer-events:none;transition:opacity .25s cubic-bezier(.4,0,.2,1),transform .25s cubic-bezier(.4,0,.2,1);box-shadow:0 24px 80px rgba(0,0,0,.12),0 4px 12px rgba(0,0,0,.06)}",
    ".ghs-dock.open .dock-panel{opacity:1;transform:translateY(0) scale(1);pointer-events:auto}",
    ".dock-header{display:flex;align-items:center;gap:10px;padding:18px 20px 14px;border-bottom:1px solid rgba(0,0,0,.06)}",
    ".dock-brand{font-family:'Source Serif 4',serif;font-weight:800;font-size:18px;color:#111827;text-decoration:none;letter-spacing:.04em}",
    ".dock-subtitle{font-size:12px;color:#6b7280;flex:1}",
    ".dock-header .theme-toggle{width:30px;height:30px;font-size:14px;border:1px solid rgba(0,0,0,.1);background:rgba(0,0,0,.03);color:#374151;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center}",
    ".dock-links{padding:12px 14px}.dock-links .nav-group{display:block;margin-bottom:10px}.dock-links .nav-group-label{display:block;font-size:10px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:rgba(0,0,0,.35);padding:4px 8px 6px}.dock-links .nav-group a{display:inline-block;color:#4b5563;font-size:12.5px;text-decoration:none;padding:5px 10px;border-radius:8px;margin:2px;transition:all .12s ease;font-weight:500}.dock-links .nav-group a:hover{color:#111827;background:rgba(0,0,0,.04)}.dock-links .nav-group a.active{color:#111827;background:rgba(0,0,0,.06);font-weight:700}",
    ".dock-links .nav-group:after{display:none}",
    ".dock-footer{display:flex;gap:10px;padding:12px 20px 16px;border-top:1px solid rgba(0,0,0,.06)}.dock-footer a{font-size:12px;color:#6b7280;text-decoration:none;padding:4px 10px;border:1px solid rgba(0,0,0,.1);border-radius:999px;transition:all .12s}.dock-footer a:hover{color:#111827;border-color:rgba(0,0,0,.2);background:rgba(0,0,0,.03)}",
    ".dock-progress{position:absolute;bottom:0;left:0;width:0;height:3px;background:linear-gradient(90deg,#374151,#111827);border-radius:0 0 50px 50px;transition:width .1s linear;z-index:3;pointer-events:none}",
    ".ghs-dock:not(.open) .dock-progress{bottom:auto;top:0;border-radius:50px 50px 0 0;left:50%;transform:translateX(-50%);width:0;height:3px;max-width:40px}",
    "@media(max-width:640px){.ghs-dock{bottom:16px;right:16px}.dock-panel{width:calc(100vw - 32px);right:-8px;bottom:60px}}",
    ""
  ), collapse = "")
}
