...
.ghs_css <- function() {
  paste(c(
    ...
    "a{color:var(--blue)}",
    ".hero{position:relative;min-height:100vh;padding:0;display:flex;align-items:center;justify-content:center;background:#f0ebe1;overflow:hidden}",
    ...
    ".hero-eyebrow{display:inline-block;padding:9px 20px;border-radius:999px;background:rgba(255,255,255,.45);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(0,0,0,.06);font-size:11px;letter-spacing:.13em;color:rgba(0,0,0,.45);font-weight:600;margin-bottom:48px;box-shadow:0 2px 8px rgba(0,0,0,.03)}",
