...
.ghs_hero <- function(s, project_url, n_fig, n_widget) {
  ...
  dock_html <- paste0(
    ...
    "<a href='https://constantine114514.shinyapps.io/ghs-dashboard/' target='_blank' rel='noreferrer'>Shiny</a>",
    "</div>",
    "</div>",
    "</div>"
  )
...
.ghs_widget_anchor <- function(widget_dir, base, label, mode = "submission",
  ...
  hint <- if (mode == "submission") "\u7ebf\u4e0a\u771f\u5b9e\u7ec4\u4ef6 \u00b7 \u6309\u9700\u52a0\u8f7d" else "\u70b9\u51fb\u5c55\u5f00\u52a0\u8f7d"
  sprintf("<details class='widget-embed' data-src='%s'><summary><strong>\u4ea4\u4e92\u7ec4\u4ef6 \u00b7 %s</strong><span class='widget-meta'>%s \u00b7 %s</span></summary><div class='widget-embed-frame'><div class='widget-placeholder'>\u5c55\u5f00\u540e\u52a0\u8f7d\u7ebf\u4e0a\u771f\u5b9e\u4ea4\u4e92\u7ec4\u4ef6\uff0c\u907f\u514d\u8bfe\u7a0b HTML \u4e00\u6b21\u6027\u62c9\u53d6\u6240\u6709 iframe\u3002</div><iframe data-src='%s' loading='lazy' title='%s' referrerpolicy='no-referrer' allowfullscreen></iframe></div><nav class='widget-embed-links'><a href='%s' target='_blank' rel='noreferrer'>\u5b8c\u6574\u7ec4\u4ef6</a><a href='%s' target='_blank' rel='noreferrer'>GitHub \u9884\u89c8</a><a href='#widgets'>\u7ec4\u4ef6\u4e2d\u5fc3</a></nav></details>",
...
.ghs_findings <- function(master, fig_dir, programs_dir, models_dir,
  ...
  f11_body <- paste0(
    ...
    .ghs_widget_anchor(widget_dir, "iadv_bar_race.html",
      "\u9ad8\u652f\u51fa\u56fd\u5bb6\u52a8\u6001\u6392\u540d", mode, repo_url),
    .ghs_limit(
  ...
  f12_body <- paste0(
    ...
    .ghs_widget_anchor(widget_dir, "28_che_life.html",
      "CHE \u4e0e\u9884\u671f\u5bff\u547d\u4ea4\u4e92\u6563\u70b9", mode, repo_url),
    .ghs_limit(
  ...
  f13_body <- paste0(
    ...
    .ghs_widget_anchor(widget_dir, "29_che_u5.html",
      "CHE \u4e0e\u513f\u7ae5\u6b7b\u4ea1\u7387\u4ea4\u4e92\u6563\u70b9", mode, repo_url),
    .ghs_limit(
  ...
  f14_body <- paste0(
    ...
    .ghs_widget_anchor(widget_dir, "iadv_lollipop_oop.html",
      "OOPS \u6781\u503c\u56fd\u5bb6\u68d2\u68d2\u7cd6\u56fe", mode, repo_url),
    .ghs_limit(
...
.ghs_widgets <- function(widget_dir, mode, repo_url) {
  ...
  default_title <- .ghs_pretty(htmls[[1]])
  default_kind <- .ghs_kind(default_title)
  ...
  frame_label <- if (mode == "submission") "\u7ebf\u4e0a\u771f\u5b9e\u7ec4\u4ef6 \u00b7 \u6309\u9700\u52a0\u8f7d" else "standalone widget"
  sprintf("<section class='section widgets' id='widgets'><div class='wrap'><header class='section-head'><span class='kicker'>S17 \u00b7 \u4ea4\u4e92\u7ec4\u4ef6\u5e93</span><h2>\u4ea4\u4e92\u7ec4\u4ef6 \u00b7 %d \u4e2a\u72ec\u7acb HTML</h2><p class='lead'>plotly \u00b7 leaflet \u00b7 reactable \u00b7 DT \u00b7 networkD3\u3002\u8bfe\u7a0b HTML \u4e0e\u7f51\u9875\u90e8\u7f72\u7248\u4f7f\u7528\u540c\u4e00\u6279\u771f\u5b9e standalone widget\uff1b\u4e3a\u4fdd\u6301\u672c\u5730 HTML \u7a33\u5b9a\u6d41\u7545\uff0c\u53f3\u4fa7\u9884\u89c8\u548c\u5404\u7ae0\u8282 iframe \u6539\u4e3a\u70b9\u51fb\u6216\u8fdb\u5165\u89c6\u53e3\u540e\u52a0\u8f7d\uff0c\u7ec4\u4ef6\u5730\u5740\u4ecd\u6307\u5411\u7ebf\u4e0a\u771f\u5b9e\u90e8\u7f72\u3002</p></header>%s<div class='tabs'>%s</div><div class='widget-lab'><div class='widget-list'>%s</div><div class='widget-frame-wrap'><div class='widget-frame-head'><strong id='widget-title'>%s</strong><span>%s</span></div><div id='widget-placeholder' class='widget-placeholder'>\u70b9\u51fb\u5de6\u4fa7\u5361\u7247\u6216\u7ee7\u7eed\u6eda\u52a8\u5230\u672c\u8282\uff0c\u5373\u53ef\u52a0\u8f7d\u7ebf\u4e0a\u771f\u5b9e\u7ec4\u4ef6\u3002</div><iframe id='widget-frame' title='interactive widget' loading='lazy' referrerpolicy='no-referrer' data-src='%s'></iframe></div></div></div></section>",
...
.ghs_footer <- function() {
  paste0(
    ...
    "<p>Shiny \u4eea\u8868\u76d8\uff1a<a href='https://constantine114514.shinyapps.io/ghs-dashboard/' target='_blank' rel='noreferrer'>constantine114514.shinyapps.io/ghs-dashboard</a></p>",
...
.ghs_css <- function() {
  paste(c(
    ...
    ".widget-placeholder{display:grid;place-items:center;min-height:180px;padding:22px;border:1px dashed rgba(120,113,108,.34);border-radius:14px;background:#fffaf2;color:#78716c;font-size:13px;line-height:1.7;text-align:center}.widget-frame-wrap .widget-placeholder{min-height:160px;margin:0 0 10px;background:#fff7e8;border-color:rgba(231,201,138,.72);color:#774314}.widget-embed-frame .widget-placeholder{position:absolute;inset:16px;z-index:1;min-height:0}.widget-embed iframe[src] + .widget-placeholder,.widget-frame-wrap.is-loaded .widget-placeholder,.widget-embed-frame.is-loaded .widget-placeholder{display:none}",
    ...
    ".modal{position:fixed;inset:0;background:rgba(37,26,16,.76);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);display:none;z-index:10000;padding:72px 28px 34px}",
    ".modal.open{display:grid;place-items:center;animation:modal-fade .18s ease both}",
    ".modal img{max-width:min(96vw,1500px);max-height:86vh;width:auto;height:auto;object-fit:contain;background:#fff9ed;border:1px solid rgba(255,249,237,.45);border-radius:10px;box-shadow:0 36px 100px rgba(0,0,0,.52)}",
    ".modal button{position:absolute;right:24px;top:20px;border:0;border-radius:8px;padding:10px 16px;font-weight:900;background:#fff9ed;color:#251a10;cursor:pointer;box-shadow:0 10px 28px rgba(0,0,0,.22)}",
    ".modal-title{position:absolute;left:28px;top:24px;right:120px;color:#fff9ed;font-weight:900;font-family:'Source Serif 4',serif;font-size:18px;line-height:1.35;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
...
.ghs_js <- function() {
  paste(c(
    ...
    "function openFigure(btn){var img=btn.querySelector('img');if(!img)return;var modal=document.getElementById('fig-modal');var target=document.getElementById('modal-img');target.src=img.currentSrc||img.src;target.alt=img.alt||'';document.getElementById('modal-title').textContent=btn.dataset.title||img.alt||'\u56fe\u8868';modal.classList.add('open');document.documentElement.classList.add('modal-lock');}",
    "function closeFigure(){var modal=document.getElementById('fig-modal');if(modal)modal.classList.remove('open');document.documentElement.classList.remove('modal-lock');}",
    ...
    "function ghsLoadDeferredFrame(f,src){if(!f)return;src=src||f.dataset.src;if(src&&!f.src){var wrap=f.parentNode;if(wrap)wrap.classList.add('is-loading');f.onload=function(){if(wrap){wrap.classList.remove('is-loading');wrap.classList.add('is-loaded');}};f.src=src;}}",
    "function loadWidgetUrl(url,title,fallback){document.getElementById('widget-title').textContent=title;var f=document.getElementById('widget-frame');var wrap=f.parentNode;if(wrap){wrap.classList.remove('is-loaded');wrap.classList.add('is-loading');}var oldBanner=document.getElementById('widget-fallback-banner');if(oldBanner)oldBanner.remove();var banner=document.createElement('div');banner.id='widget-fallback-banner';banner.className='widget-fallback-banner';banner.innerHTML='\u6b63\u5728\u52a0\u8f7d <strong>'+title+'</strong>\u2026 \u82e5\u957f\u65f6\u95f4\u7a7a\u767d\uff0c\u8bf7 <a href=\"'+(fallback||url)+'\" target=\"_blank\" rel=\"noreferrer\">\u5728\u65b0\u7a97\u6253\u5f00</a>\u3002';wrap.insertBefore(banner,f);f.onload=function(){if(wrap){wrap.classList.remove('is-loading');wrap.classList.add('is-loaded');}banner.classList.add('loaded');banner.innerHTML='\u5df2\u52a0\u8f7d <strong>'+title+'</strong>\u3002\u82e5\u663e\u793a\u4e0d\u5b8c\u6574\uff0c\u53ef <a href=\"'+(fallback||url)+'\" target=\"_blank\" rel=\"noreferrer\">\u5728\u65b0\u7a97\u6253\u5f00</a>\u3002';};f.onerror=function(){if(wrap)wrap.classList.remove('is-loading');banner.classList.add('error');banner.innerHTML='\u65e0\u6cd5\u76f4\u63a5\u5728\u53f3\u4fa7\u52a0\u8f7d <strong>'+title+'</strong>\uff0c\u8bf7 <a href=\"'+(fallback||url)+'\" target=\"_blank\" rel=\"noreferrer\">\u5728\u65b0\u7a97\u6253\u5f00</a>\u3002';};f.dataset.src=url;f.src=url;if(window.ghsScrollToId)window.ghsScrollToId('widgets',true);if(window.ghsCloseDock)window.ghsCloseDock();if(window.ghsCloseMobileToc)window.ghsCloseMobileToc();}",
    ...
    "document.addEventListener('toggle',function(e){var d=e.target;if(d&&d.tagName==='DETAILS'&&d.classList.contains('widget-embed')&&d.open){ghsLoadDeferredFrame(d.querySelector('iframe[data-src]'));}},true);",
    "(function(){var ios=('IntersectionObserver' in window)?new IntersectionObserver(function(es){es.forEach(function(en){if(en.isIntersecting){ghsLoadDeferredFrame(en.target);ios.unobserve(en.target);}});},{rootMargin:'220px 0px'}):null;document.querySelectorAll('iframe[data-src]').forEach(function(f){if(ios){ios.observe(f);}});})();",
...
.ghs_css_material_final <- function() {
  paste(c(
    ...
    ".hero{min-height:100svh!important;min-height:100vh!important;align-items:center!important;padding:70px 0 96px!important;background:var(--final-paper)!important}",
    ...
    ".hero{isolation:isolate!important;background:linear-gradient(180deg,#f4e6cc 0%,#f7ead3 48%,#f1dfbd 100%)!important}",
    ".hero:before{content:''!important;display:block!important;position:absolute!important;inset:0!important;z-index:0!important;pointer-events:none!important;background:repeating-linear-gradient(90deg,rgba(64,43,23,.045) 0 1px,transparent 1px 92px),repeating-linear-gradient(0deg,rgba(64,43,23,.035) 0 1px,transparent 1px 72px)!important;background-size:92px 72px!important;animation:ghs-hero-paper-drift 18s linear infinite!important}",
    ".hero:after{content:''!important;display:block!important;position:absolute!important;left:6vw!important;right:6vw!important;top:18vh!important;bottom:18vh!important;z-index:0!important;pointer-events:none!important;border:1px solid rgba(64,43,23,.13)!important;border-radius:18px!important;background:transparent!important;box-shadow:inset 0 0 0 1px rgba(255,249,237,.55)!important;animation:ghs-hero-frame 8s ease-in-out infinite!important}",
    ...
    ".hero-center{width:min(1120px,88vw)!important;z-index:1!important}.hero h1{letter-spacing:0!important;text-shadow:none!important;color:var(--final-ink)!important}",
    ".hero-reveal{opacity:0;transform:translateY(24px);filter:blur(3px);animation:ghs-hero-rise .9s cubic-bezier(.16,1,.3,1) both}.hero-reveal.in{opacity:1;transform:translateY(0);filter:blur(0)}.hero-eyebrow{animation-delay:.08s}.hero-line1{animation-delay:.22s}.hero-line2{animation-delay:.38s}.hero-line3{animation-delay:.54s}.hero h1{animation:ghs-title-breathe 7s ease-in-out 1.2s infinite}.hero h1 span{will-change:transform,opacity,filter}",
    ...
    ".widget-frame-head,.widget-frame-head strong{color:var(--final-ink)!important}",
    ".widget-frame-head span{color:var(--final-muted)!important}",
    ...
    ".ghs-dock{display:block!important;visibility:visible!important;opacity:1!important;background:transparent!important;background-image:none!important;border:0!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;pointer-events:auto!important;isolation:isolate!important}",
    ...
    "@keyframes ghs-hero-paper-drift{0%{background-position:0 0,0 0}100%{background-position:92px 72px,-92px 0}}",
    "@keyframes ghs-hero-frame{0%,100%{opacity:.44;transform:translateY(0) scale(.985)}50%{opacity:.82;transform:translateY(-9px) scale(1.012)}}",
    "@media(prefers-reduced-motion:reduce){.hero h1,.hero-reveal,.hero:before,.hero:after{animation:none!important}}",
