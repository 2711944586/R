...
.ghs_nav_items <- function() {
  list(
    ...
    list(group = "2 \u53d1\u73b0", items = list(
      ...
      list(id = "countries", label = "2.5 \u56fd\u5bb6"),
      list(id = "regional", label = "2.6 \u533a\u57df"),
      list(id = "period", label = "2.7 \u5206\u671f")
    )),
    ...
    list(group = "4 \u5de5\u5177", items = list(
      ...
      list(id = "gallery", label = "4.2 \u56fe\u5e93"),
      list(id = "widgets", label = "4.3 \u4ea4\u4e92\u7ec4\u4ef6")
    )),
...
.ghs_hero <- function(s, project_url, n_fig, n_widget) {
  ...
  sprintf(
    paste0(
      ...
      "<header class='hero' id='top'><div class='hero-bg'><div class='hero-grid-lines'></div><div class='hero-dots'></div><div class='hero-gradient'></div></div>",
      "<div class='hero-center'>",
      "<span class='hero-eyebrow hero-anim' data-delay='200'>GLOBAL HEALTH EXPENDITURE \u00b7 195 COUNTRIES \u00b7 23 YEARS</span>",
      "<h1>",
      "<span class='hero-line1 hero-anim' data-delay='400'>\u5168\u7403\u536b\u751f\u652f\u51fa</span>",
      "<span class='hero-line2 hero-anim' data-delay='600'>2000\u20132023\uff1a</span>",
      "<span class='hero-line3 hero-anim' data-delay='800'><em>\u516c\u5e73\u3001\u97e7\u6027\u3001\u672a\u6765</em></span>",
      "</h1>",
      "</div>",
      "</header>"
    ),
...
.ghs_js <- function() {
  paste(c(
    ...
    "(function(){var heroEls=document.querySelectorAll('.hero-anim');if(!heroEls.length)return;var obs=new IntersectionObserver(function(entries){entries.forEach(function(en){if(en.isIntersecting){var el=en.target;var d=parseInt(el.dataset.delay||0);setTimeout(function(){el.classList.add('visible');},d);}else{el.classList.remove('visible');}});},{threshold:0.1});heroEls.forEach(function(el){obs.observe(el);});})();",
