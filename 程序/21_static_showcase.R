...
.ghs_hero <- function(s, project_url, n_fig, n_widget) {
  ...
  sprintf(
    paste0(
      ...
      "<span class='hero-eyebrow' style='animation:ghs-fade-in .7s ease .2s both'>GLOBAL HEALTH EXPENDITURE \u00b7 195 COUNTRIES \u00b7 23 YEARS</span>",
      "<h1>",
      "<span class='hero-line1' style='animation:ghs-slide-up .8s cubic-bezier(.16,1,.3,1) .4s both'>\u5168\u7403\u536b\u751f\u652f\u51fa</span>",
      "<span class='hero-line2' style='animation:ghs-slide-up .8s cubic-bezier(.16,1,.3,1) .6s both'>2000\u20132023\uff1a</span>",
      "<span class='hero-line3' style='animation:ghs-slide-up .8s cubic-bezier(.16,1,.3,1) .8s both'><em>\u516c\u5e73\u3001\u97e7\u6027\u3001\u672a\u6765</em></span>",
      "</h1>",
      "</div>",
      "</header>"
    ),
...
.ghs_css <- function() {
  paste(c(
    ":root{--ink:#1a1a1a;--muted:#78716c;--paper:#faf8f5;--paper-2:#f3efe8;--line:rgba(0,0,0,.06);--line-strong:rgba(0,0,0,.1);--blue:#292524;--orange:#44403c;--green:#059669;--code-bg:#1c1917;--code-ink:#fafaf9}",
    ...
    "a{color:var(--blue)}",
    ".hero{position:relative;min-height:100vh;padding:0;display:flex;align-items:center;justify-content:center;background:#f5f0e6;overflow:hidden}",
    ".hero:before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 50%,rgba(255,252,245,.6),transparent),radial-gradient(circle at 20% 80%,rgba(235,220,195,.3),transparent 45%);pointer-events:none}",
    ".hero:after{content:'';position:absolute;inset:0;background:url(\"data:image/svg+xml,%3Csvg width='80' height='80' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='1' cy='1' r='.3' fill='rgba(0,0,0,.012)'/%3E%3C/svg%3E\");pointer-events:none}",
    ".hero-center{position:relative;z-index:2;text-align:left;max-width:1100px;width:min(1100px,88vw);padding:0}",
    ".hero-eyebrow{display:inline-block;padding:8px 18px;border-radius:999px;background:rgba(0,0,0,.04);border:1px solid rgba(0,0,0,.08);font-size:11px;letter-spacing:.13em;color:rgba(0,0,0,.4);font-weight:600;margin-bottom:40px}",
    ".hero h1{font-family:'Source Serif 4',Georgia,serif;font-size:clamp(44px,8.5vw,105px);font-weight:800;line-height:1.02;letter-spacing:-.035em;margin:0;color:#1a1a1a}",
    ".hero .hero-line1{display:block}",
    ".hero .hero-line2{display:block}",
    ".hero .hero-line3{display:block}",
    ".hero .hero-line3 em{font-style:normal;color:#b07d4f}",
    ".hero-main{display:none}",
    ".hero-sub{display:none}",
    "@keyframes ghs-fade-in{from{opacity:0}to{opacity:1}}",
    "@keyframes ghs-slide-up{from{opacity:0;transform:translateY(40px)}to{opacity:1;transform:translateY(0)}}",
    ...
    ".kpi-section{background:linear-gradient(180deg,#faf8f5,#f3efe8)}",
    ...
    ".finding:nth-of-type(odd){background:linear-gradient(180deg,#faf8f5,#f3efe8)}",
