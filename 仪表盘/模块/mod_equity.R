...
mod_equity_ui <- function(id, year_min, year_max) {
  ...
  bslib::nav_panel(
    ...
    mod_v3_hero(
      ...
      meta = list("\u4eba\u53e3\u52a0\u6743\u4e0d\u5e73\u7b49", "Lorenz \u66f2\u7ebf\u5bf9\u7167", "OOPS \u5bb6\u5ead\u8d1f\u62c5\u6392\u540d")
    ),
    mod_v3_page_body(
      wide = TRUE,
      mod_v3_badge_row(
      ...
      bslib::layout_sidebar(
        ...
        mod_card(
          ...
          mod_v3_chart_guide(
            "\u590d\u6838\u53e3\u5f84",
            "\u8868\u683c\u4fdd\u7559\u6bcf\u5e74 Gini\u3001Theil-T \u548c Atkinson \u7684\u6570\u503c\uff0c\u7528\u4e8e\u5bf9\u7167\u56fe\u4e2d\u8f6c\u6298\u70b9\u662f\u4e0d\u662f\u6765\u81ea\u6570\u503c\u7ea7\u522b\u7684\u771f\u5b9e\u53d8\u5316\u3002",
            tone = "info"
          ),
          mod_spinner(reactable::reactableOutput(ns("inequality_table"))),
          footer = "Atkinson \u7684 \u03b5 \u8d8a\u5927\uff0c\u5bf9\u4f4e\u7aef\u56fd\u5bb6\u7684\u6743\u91cd\u8d8a\u9ad8\uff1b\u8fd9\u4e2a\u8868\u683c\u9002\u5408\u548c Lorenz \u66f2\u7ebf\u4e00\u8d77\u8bfb\u3002"
        ),
        mod_card(
          kicker = "\u5bb6\u5ead\u8d1f\u62c5",
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    output$indices_ts <- plotly::renderPlotly({
      ...
      p <- ggplot2::ggplot(d2, ggplot2::aes(year, value, colour = index)) +
        ...
        ggplot2::labs(x = NULL, y = "\u4e0d\u5e73\u7b49\u6307\u6570 (0\u20131)") +
    ...
    output$inequality_table <- reactable::renderReactable({
      ...
      df <- data.frame(
        ...
        theil = round(d$theil_pop, 3),
        atk05 = round(d$atk05, 3),
        atk1 = round(d$atk1, 3),
        atk2 = round(d$atk2, 3),
        gini_delta = round(d$gini_pop - first_gini, 3),
        check.names = FALSE
      )
      names(df) <- c("\u5e74\u4efd", "Gini", "Theil-T",
                     "Atkinson \u03b5=0.5", "Atkinson \u03b5=1",
                     "Atkinson \u03b5=2", "Gini \u8f83\u9996\u5e74\u53d8\u5316")
      reactable::reactable(df, defaultPageSize = 12, highlight = TRUE,
        defaultColDef = reactable::colDef(headerStyle = list(background = "#f1f3f7")),
        columns = list(
          "\u5e74\u4efd" = reactable::colDef(align = "center"),
          "Gini" = reactable::colDef(align = "right",
            style = function(value) {
              col <- if (is.na(value)) "#68707d"
                     else if (value >= 0.45) "#B24A4A"
                     else if (value >= 0.35) "#B46A1B"
                     else "#2F7D5B"
              list(color = col, fontWeight = 700)
            }),
          "Theil-T" = reactable::colDef(align = "right"),
          "Atkinson \u03b5=0.5" = reactable::colDef(align = "right"),
          "Atkinson \u03b5=1" = reactable::colDef(align = "right"),
          "Atkinson \u03b5=2" = reactable::colDef(align = "right"),
          "Gini \u8f83\u9996\u5e74\u53d8\u5316" = reactable::colDef(align = "right")
        ))
    })
    ...
    output$catastrophic_table <- reactable::renderReactable({
      ...
      d <- data.frame(
        ...
        oops_pct    = round(d$hf3_che, 1),
        che_pc = round(d$che_pc_usd2023, 0),
        check.names = FALSE
      )
      names(d) <- c("\u6392\u540d", "\u56fd\u5bb6", "\u5927\u6d32", "\u6536\u5165\u7ec4",
                    "OOPS %", "\u4eba\u5747 CHE (USD)")
